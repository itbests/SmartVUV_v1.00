...
class MenuSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('menu')->insert(['id' => 3, 'name_' => 'user_profiles', 'display_name' => 'Roles de Aplicación', 'menu_dad_id' => 1, 'link_command' => 'app/profile', 'tooltip' => 'Perfiles de Usuario', 'image_icon' => '', 'status_id' => 1, 'breadcrumb' => '', 'menu_type_id' => 2]);
